...
export interface NetworkFirewallDistributedProps {
  vpc: cdk.aws_ec2.IVpc;
  subnetList: Array<cdk.aws_ec2.ISubnet>;
  rulesFile?: Array<fs.PathOrFileDescriptor>;
}

export class NetworkFirewallDistributed extends Construct {

  private vpc: cdk.aws_ec2.IVpc;

  constructor(scope: Construct, id: string, props: NetworkFirewallDistributedProps) {
    super(scope, id);
